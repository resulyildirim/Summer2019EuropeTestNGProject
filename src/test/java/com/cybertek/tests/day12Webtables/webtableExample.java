package com.cybertek.tests.day12Webtables;
...
public class webtableExample {
    ...
    public void printTable(){
        ...
        Assert.assertTrue(wholetable.contains("jsmith@gmail.com "));
//        WebElement table =driver.findElement(By.id("table1"));
//       // System.out.println(table.getText());
//        String wholetable=table.getText();
//        //verify that jsmith@gmail.com is in thetable
//        Assert.assertTrue(wholetable.contains("jsmith@gmail.com "),"Verify jsmith@gmail.com is in the table");
    }
    @Test
    public void getAllHeaders(){
        //how many columns we have ?
        List<WebElement>firstrow =driver.findElements(By.xpath("//table[@id='table1']/tbody/tr[2]//td"));
        System.out.println(firstrow.size());
        for (WebElement allrow:firstrow){
...
//        }
    ...
    @Test
    public void getSpecificCllByIndex(){
        int r=2;
        int c =3;
